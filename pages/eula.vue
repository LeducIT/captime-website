  ...
  <div class="h-full">
    <div class="prose prose-sm text-left m-auto pt-8 text-white">
      ...
      <p>
        ...
        the &quot;I Agree&quot; button, downloading or using {{ brand }}.
      </p>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            the Company downloaded by You through an Application Store's account
            to a Device, named {{ brand }}
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Digital shift OU, 6 sepapaja 15510
            Tallinn.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Family Sharing / Family Group</strong> permits You to share
      ...
      <p>
        ...
        not click on the &quot;I Agree&quot; button, do not download or do not
        use the Application.
      </p>
      <p>
