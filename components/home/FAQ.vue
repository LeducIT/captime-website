...
const faqs = [
  {
    id: 1,
    question: 'Where get the app?',
    answer:
        'You can get Captime free on the Apple App Store for iPhone. And in Google Play for Android.',
  },
  {
    id: 2,
    question: 'Where use the app?',
    answer:
        'Captime is perfect for workouts at your home gym or garage gym. However the app is also great for workouts outside or at a regular gym.',
  },
  {
    id: 2,
...
`,
  ...
  {
    id: 3,
    question: 'What is AMRAP, EMOM and TABATA?',
    answer:
        ...
        <dl class="mt-6 space-y-6 divide-y divide-gray-200">
          <Disclosure v-for="faq in faqs" :key="faq.question" v-slot="{ open }" as="div" class="pt-6">
            ...
            <DisclosurePanel as="dd" class="mt-2 pr-12">
              <p class="text-base text-gray-500 whitespace-pre-wrap">
                {{ faq.answer }}
              </p>
            </DisclosurePanel>
          </Disclosure>
