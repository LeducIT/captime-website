      ...
      <div class="text-center xl:flex xl:items-center xl:justify-between xl:text-left">
        ...
        <div class="items-center mt-8 xl:mt-0 xl:flex xl:justify-end xl:space-x-8">
          <ul class="flex flex-wrap items-center justify-center gap-x-8 gap-y-3 xl:justify-end">
            <!-- <li>
              <a href="/about" title="" class="text-sm text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> About </a>
            </li>

            <li>
              <a href="/services" title="" class="text-sm text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Services </a>
            </li> -->

            <li>
              <a href="/privacy" title="" class="text-sm text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Privacy Policy </a>
            </li>

            <li>
              <a href="/tos" title="" class="text-sm text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80"> Terms & Conditions </a>
            </li>
          ...
          <div class="w-full h-px mt-8 mb-5 xl:w-px xl:m-0 xl:h-6 bg-gray-50/20" />

          <ul class="flex items-center justify-center space-x-8 xl:justify-end">
            <!-- <li>
              <a href="#" title="twitter account" class="block text-white transition-all duration-200 hover:text-opacity-80 focus:text-opacity-80">
